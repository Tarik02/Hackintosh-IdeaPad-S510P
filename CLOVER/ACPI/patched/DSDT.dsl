 ...
 *
 * Disassembly of iASLYCn0yi.aml, Thu Jan  9 16:22:19 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000DAAC (55980)
 *     Revision         0x02
 *     Checksum         0x2C
 *     OEM ID           "LENOVO"
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "HSW-LPT", 0x00000000)
{
    ...
    External (IGDS, MethodObj)    // Warning: Unknown method, guessing 2 arguments
    ...
    Scope (\)
    {
        OperationRegion (CNVS, SystemMemory, 0xC2F7E018, 0x00000800)
            ...
            Method (XCMD, 1, Serialized)
            {
                Switch (Arg0)
                {
                    ...
                    Case (0x2B)
                    {
                        ...
                        If ((DUST == One))
                        {
                            VDAT |= 0x02 /* \_SB_.PCI0.LPCB.EC0_.VDAT */
                        }
                        ElseIf (((DUS1 == One) && (DUS2 == Zero)))
                        {
                            VDAT |= 0x84 /* \_SB_.PCI0.LPCB.EC0_.VDAT */
                        }
                        Else
                        {
                            VDAT |= 0x04 /* \_SB_.PCI0.LPCB.EC0_.VDAT */
                        }
                    }
                    Case (0x2F)
                    {
